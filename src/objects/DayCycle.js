class DayCycle {
    ...
    sunrise(sprite) {
        ...
        if(this.shading) this.shading.forEach((sprite) => {
    ...
    sunset(sprite) {
        ...
        this.sunTween = this.game.add.tween(sprite).to({y:this.game.height}, this.dayLength, null, true);
    ...
    moonset(sprite) {
        ...
        this.moonTween = this.game.add.tween(sprite).to({y:this.game.height}, this.dayLength, null, true);
